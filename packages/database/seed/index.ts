...
const vesselsData = [
  ...
  // =========================================
  {
    ...
    description: 'The flagship AY60 Sport with triple outboard configuration for maximum performance and efficiency. This revolutionary 60-foot power catamaran is designed for those who demand performance, luxury, and adventure without compromise.',
    shortDescription: 'The flagship AY60 Sport with triple outboard configuration',
    featuredImageUrl: '/images/ay60-gallery-1.png',
    galleryImages: [
      '/images/ay60-gallery-1.png',
